...
public class GameStatisticsPane extends GridPane implements GameUIComponent {
    ...
    private void setNumGems(int value) {
        // TODO: ok Update the text of the corresponding label with Gems: <number> (e.g., Gems: 1).
        numGemsLabel.setText("Gems: " + value);
    }

    private void setNumMoves(int value) {
        // TODO: ok Update the text of the corresponding label with Move <number> (e.g., Move: 1).
        numMovesLabel.setText("Move: " + value);
    }

    private void setNumUndoes(int value) {
        // TODO: ok Update the text of the corresponding label with Undoes: <number> (e.g., Undoes: 1).
        numUndoesLabel.setText("Undoes: " + value);
    }

    private void setNumDeaths(int value) {
        // TODO: ok Update the text of the corresponding label with Deaths: <number> (e.g., Deaths: 1).
        numDeathsLabel.setText("Deaths: " + value);
    }

    private void setNumLives(int value, boolean hasUnlimitedLives) {
        // TODO: ok Update the text of the corresponding label with Lives: <number>, \
    ...
    private void setScore(int value) {
        // TODO: ok Update the text of the corresponding label with Score: <number> (e.g., Score: 1).
